...
@section('content')
    ...
    <div class="user_create">
        <form action="{{ route('roles.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                <input onclick="countCheckboxes(this);" type="checkbox" id="globalSelectAll" class="form-check-input">
                            ...
                            @if(collect($permissions)->contains(function($permission) use ($entity) {
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="view_{{ $entity }}"
                                        onclick="togglePermissions(['{{ $entity }}-index', '{{ $entity }}-show'], this); event.stopPropagation();">
                            ...
                            @if(collect($permissions)->contains(function($permission) use ($entity) {
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="store_{{ $entity }}"
                                        onclick="togglePermissions(['{{ $entity }}-create', '{{ $entity }}-store'], this); event.stopPropagation();">
                            ...
                            @if(collect($permissions)->contains(function($permission) use ($entity) {
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="update_{{ $entity }}"
                                        onclick="togglePermissions(['{{ $entity }}-edit', '{{ $entity }}-update'], this); event.stopPropagation();">
